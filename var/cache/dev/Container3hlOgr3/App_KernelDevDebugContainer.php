...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getAdminUrlGeneratorService()
    {
        $this->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator'] = function () {
            return new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminUrlGenerator(($this->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Provider\\AdminContextProvider'] ?? $this->getAdminContextProviderService()), ($this->services['router'] ?? $this->getRouterService()), ($this->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\DashboardControllerRegistry'] ??= new \EasyCorp\Bundle\EasyAdminBundle\Registry\DashboardControllerRegistry($this->targetDir.'', ['App\\Controller\\Admin\\DashboardController' => '3fa704b'], ['3fa704b' => 'App\\Controller\\Admin\\DashboardController'])));
        };
    ...
    protected function getDoctrine_Dbal_DefaultConnection_EventManagerService()
    {
        ...
        ]), [0 => 'vich_uploader.listener.clean.poster_file', 1 => 'doctrine.orm.messenger.doctrine_schema_subscriber', 2 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 3 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 4 => 'vich_uploader.listener.remove.poster_file', 5 => 'vich_uploader.listener.upload.poster_file', 6 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]);
    }
