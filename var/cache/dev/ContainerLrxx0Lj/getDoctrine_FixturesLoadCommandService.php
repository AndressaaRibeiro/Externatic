...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\CategoryFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\CompanyFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\SubjectFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\User(), 'groups' => []]]);
