...
class __TwigTemplate_e5af5607fbd32dcc18dbf13a0ab5028e extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 7
        $this->loadTemplate("profil/edit.html.twig", "profil/edit.html.twig", 7, "282639213")->display($context);
...
{% block body %}
    ...
    {% embed '_dashboardProfil.html.twig' %}
        ...
        {% block extra_content %}
            ...
            <h1 class=\"text-center mt-4 mb-4\">Modifier votre profil</h1>

            {{ include('profil/_form.html.twig', {'button_label': 'Mettre à jour'}) }}

        {% endblock %}
    {% endembed %}
{% endblock %}
", "profil/edit.html.twig", "/Users/Andressa/Desktop/032023-PHP-SXB-externatic/templates/profil/edit.html.twig");
    }
}


/* profil/edit.html.twig */
class __TwigTemplate_e5af5607fbd32dcc18dbf13a0ab5028e___282639213 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("_dashboardProfil.html.twig", "profil/edit.html.twig", 7);
        $this->parent->display($context, array_merge($this->blocks, $blocks));
    ...
    public function block_extra_content($context, array $blocks = [])
    {
        ...
        echo "    
            ...
            ";
        // line 13
        echo twig_include($this->env, $context, "profil/_form.html.twig", ["button_label" => "Mettre à jour"]);
        echo "
    ...
    public function getDebugInfo()
    {
        return array (  196 => 13,  191 => 10,  181 => 9,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
